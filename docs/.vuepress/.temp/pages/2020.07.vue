<template><h1 id="_7月你好"><a class="header-anchor" href="#_7月你好">#</a> 7月你好</h1>
<h2 id="_07-06"><a class="header-anchor" href="#_07-06">#</a> 07.06</h2>
<h3 id="观察者与发布订阅的不同"><a class="header-anchor" href="#观察者与发布订阅的不同">#</a> 观察者与发布订阅的不同</h3>
<p><a href="https://juejin.im/post/5cd81a20e51d453b4558d858" target="_blank" rel="noopener noreferrer">参考<OutboundLink/></a></p>
<p>观察者模式</p>
<p>简单来说，观察者模式就是，一个对象（被观察者）的状态发生改变时，会通知所有依赖它的对象（观察者），这两者是直接关联的。</p>
<p>实现：</p>
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code><span class="token keyword">const</span> subject <span class="token operator">=</span> <span class="token punctuation">{</span>
...
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br><span class="line-number">17</span><br><span class="line-number">18</span><br><span class="line-number">19</span><br><span class="line-number">20</span><br><span class="line-number">21</span><br><span class="line-number">22</span><br><span class="line-number">23</span><br></div></div><p>订阅发布模式</p>
<p>是一种消息范式，消息的发送者（称为发布者）不会将消息直接发送给特定的接收者（称为订阅者）。而是将发布的消息分为不同的类别，无需了解哪些订阅者（如果有的话）可能存在。同样的，订阅者可以表达对一个或多个类别的兴趣，只接收感兴趣的消息，无需了解哪些发布者（如果有的话）存在。</p>
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code><span class="token keyword">const</span> pubSub <span class="token operator">=</span> <span class="token punctuation">{</span>
...
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br><span class="line-number">17</span><br><span class="line-number">18</span><br><span class="line-number">19</span><br><span class="line-number">20</span><br><span class="line-number">21</span><br><span class="line-number">22</span><br><span class="line-number">23</span><br><span class="line-number">24</span><br><span class="line-number">25</span><br><span class="line-number">26</span><br><span class="line-number">27</span><br><span class="line-number">28</span><br><span class="line-number">29</span><br><span class="line-number">30</span><br></div></div><h2 id="_07-08"><a class="header-anchor" href="#_07-08">#</a> 07.08</h2>
<h3 id="http2相较于http1的改进"><a class="header-anchor" href="#http2相较于http1的改进">#</a> http2相较于http1的改进</h3>
<p>在浏览器端，http1对同一域名下的请求具有数量限制，超过限制的将会被阻塞。</p>
<p>每一个http1的请求都对应着一个TCP连接，http2只需要建立一个TCP链接。</p>
<p>http2同过从http层(应用层)以及tcp层(传输层)上采用二进制分针层，将传输的最小信息分割为帧，每一个帧都对应不同的标识，这样可以实现在一个TCP上的多路复用。</p>
<h3 id="数组扁平化"><a class="header-anchor" href="#数组扁平化">#</a> 数组扁平化</h3>
<p>已知如下数组：</p>
<p><code>var arr = [ [1, 2, 2], [3, 4, 5, 5], [6, 7, 8, 9, [11, 12, [12, 13, [14] ] ] ], 10];</code></p>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br></div></div><h3 id="new-运算符都做了哪些工作以及如何实现一个new操作符"><a class="header-anchor" href="#new-运算符都做了哪些工作以及如何实现一个new操作符">#</a> new 运算符都做了哪些工作以及如何实现一个new操作符</h3>
<ol>
<li>创建一个新对象；</li>
<li>将this指向新对象</li>
<li>将新对象的原型指向构造函数的原型</li>
<li>返回一个对象（如果构造函数本身有返回值且是对象类型，就返回本身的返回值，如果没有才返回新对象）</li>
</ol>
<p>实现一个new</p>
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code><span class="token keyword">function</span> <span class="token function">myNew</span> <span class="token punctuation">(</span><span class="token parameter">myconstructor<span class="token punctuation">,</span> <span class="token operator">...</span>args</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
...
<p>然后再说一下优化方向。</p>
<p>回流：当render tree中的一部分(或全部)因为元素的规模尺寸，布局，隐藏等改变而需要重新构建。（文档的排版需要改变）</p>
<p>重绘：当render tree中的一些元素需要更新属性，而这些属性只是影响元素的外观，风格，而不会影响布局的，比如background-color。</p>
<p>减少回流重绘</p>
<ol>
<li>最小化重绘和重排：</li>
</ol>
...
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br></div></div><p>修改CSS的class</p>
<ol start="2">
<li>批量修改DOM</li>
</ol>
<p>(1) 使元素脱离文档流
...
<p>https://www.zhoulujun.cn/html/webfront/browser/webkit/2016_0506_7820.html
https://juejin.im/post/5c6cb7b4f265da2dae511a3d?utm_source=gold_browser_extension</p>
<h3 id="sleep-1000"><a class="header-anchor" href="#sleep-1000">#</a> sleep(1000);</h3>
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code><span class="token keyword">function</span> <span class="token function">sleet</span><span class="token punctuation">(</span><span class="token parameter">time</span><span class="token punctuation">)</span> <span class="token punctuation">(</span>
...
<span class="token punctuation">}</span><span class="token punctuation">)</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br></div></div><p>call与apply的区别以及性能对比</p>
<p>call与apply的区别就在于参数上，其中，apply接收的第二个参数可以是集合，数组或者类数组，call接收的参数是零散的，对应函数的参数。</p>
<p>性能上，call要优于apply，因为apply要对传输的第二个参数进行判断。</p>
<h3 id="为什么要用1x1的gif进行打点"><a class="header-anchor" href="#为什么要用1x1的gif进行打点">#</a> 为什么要用1X1的gif进行打点？</h3>
<p><a href="https://mp.weixin.qq.com/s/v6R2w26qZkEilXY0mPUBCw?utm_source=tuicool&amp;utm_medium=referral" target="_blank" rel="noopener noreferrer">参考<OutboundLink/></a></p>
<ol>
<li>没有跨域的困扰；</li>
<li>相比于请求其他资源，不需要插入到DOM中，即可发起请求；</li>
<li>不会对页面产生阻塞；</li>
<li>相比于其他格式的图片，gif的文件格式类型最小；</li>
</ol>
<h3 id="怎么让一个-div-水平垂直居中"><a class="header-anchor" href="#怎么让一个-div-水平垂直居中">#</a> 怎么让一个 div 水平垂直居中</h3>
...
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br></div></div><div class="language-css ext-css line-numbers-mode"><pre v-pre class="language-css"><code><span class="token comment">/* 第一种 */</span>
...
<p>可以简单地理解，栈内存比较快，堆内存较慢。</p>
<p>javascript中，基本数据类型存放在栈内存中，引用类型存放在堆内存中。</p>
<p>但是闭包中引用的变量存放在堆内存中。</p>
<h3 id="冒泡排序"><a class="header-anchor" href="#冒泡排序">#</a> 冒泡排序</h3>
<blockquote>
<p>从头开始，比较相邻的两个数，如果第一个数大于第二个数，就交换他们两个的位置
然后从交换的位置开始，继续执行第1步的比较策略
经过一轮循环之后，最大的数就会被放到最后
重复上面的步骤，知道没有任何一对数字需要比较</p>
</blockquote>
<p>理解：将最大元素冒到最后面</p>
...
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br><span class="line-number">17</span><br><span class="line-number">18</span><br><span class="line-number">19</span><br><span class="line-number">20</span><br><span class="line-number">21</span><br><span class="line-number">22</span><br><span class="line-number">23</span><br><span class="line-number">24</span><br><span class="line-number">25</span><br><span class="line-number">26</span><br><span class="line-number">27</span><br><span class="line-number">28</span><br><span class="line-number">29</span><br><span class="line-number">30</span><br><span class="line-number">31</span><br><span class="line-number">32</span><br><span class="line-number">33</span><br><span class="line-number">34</span><br><span class="line-number">35</span><br><span class="line-number">36</span><br><span class="line-number">37</span><br><span class="line-number">38</span><br><span class="line-number">39</span><br><span class="line-number">40</span><br><span class="line-number">41</span><br><span class="line-number">42</span><br><span class="line-number">43</span><br><span class="line-number">44</span><br><span class="line-number">45</span><br><span class="line-number">46</span><br><span class="line-number">47</span><br><span class="line-number">48</span><br><span class="line-number">49</span><br><span class="line-number">50</span><br><span class="line-number">51</span><br></div></div><h3 id="选择排序"><a class="header-anchor" href="#选择排序">#</a> 选择排序</h3>
<blockquote>
<p>在未排序的序列中找到最小元素，放到排序序列的起始位置
从剩下未排序的元素中继续寻找最小的元素，放到已排序序列的末尾
重复第2步骤，到所有元素排列完毕</p>
</blockquote>
<p>理解： 选择出最小的数，放在前面</p>
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code><span class="token keyword">function</span> <span class="token function">select</span> <span class="token punctuation">(</span><span class="token parameter">arr</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
  <span class="token keyword">for</span> <span class="token punctuation">(</span><span class="token keyword">let</span> i <span class="token operator">=</span> <span class="token number">0</span><span class="token punctuation">;</span> i <span class="token operator">&lt;</span> arr<span class="token punctuation">.</span>length <span class="token operator">-</span> <span class="token number">1</span><span class="token punctuation">;</span> i<span class="token operator">++</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
  ...
  <span class="token keyword">return</span> arr<span class="token punctuation">;</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br></div></div><h3 id="插入排序"><a class="header-anchor" href="#插入排序">#</a> 插入排序</h3>
<blockquote>
<p>将第一个元素看做一个有序序列，把第二个元素到最后一个元素当成是未排序序列
从头到尾依次扫描未排序序列，将扫描到的每个元素插入有序序列的适当位置，相等的话就排到相等元素的后面.</p>
</blockquote>
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code><span class="token keyword">function</span> <span class="token function">insertSort</span> <span class="token punctuation">(</span><span class="token parameter">arr</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
  ...
  <span class="token keyword">return</span> arr<span class="token punctuation">;</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br></div></div><h3 id="归并排序"><a class="header-anchor" href="#归并排序">#</a> 归并排序</h3>
<p><a href="https://juejin.im/post/5d371aa6e51d455d850d3bbe" target="_blank" rel="noopener noreferrer">参考<OutboundLink/></a></p>
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code><span class="token keyword">function</span> <span class="token function">mergeSort</span><span class="token punctuation">(</span><span class="token parameter">arr</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br><span class="line-number">17</span><br><span class="line-number">18</span><br><span class="line-number">19</span><br><span class="line-number">20</span><br><span class="line-number">21</span><br><span class="line-number">22</span><br><span class="line-number">23</span><br><span class="line-number">24</span><br><span class="line-number">25</span><br><span class="line-number">26</span><br><span class="line-number">27</span><br><span class="line-number">28</span><br><span class="line-number">29</span><br><span class="line-number">30</span><br><span class="line-number">31</span><br><span class="line-number">32</span><br></div></div><h3 id="快速排序"><a class="header-anchor" href="#快速排序">#</a> 快速排序</h3>
<blockquote>
<p>先找到一个基准点（一般指数组的中部），然后数组被该基准点分为两部分，依次与该基准点数据比较，如果比它小，放左边；反之，放右边。
左右分别用一个空数组去存储比较后的数据。
最后递归执行上述操作，直到数组长度 &lt;= 1;</p>
</blockquote>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br><span class="line-number">17</span><br><span class="line-number">18</span><br><span class="line-number">19</span><br><span class="line-number">20</span><br><span class="line-number">21</span><br><span class="line-number">22</span><br></div></div><h3 id="箭头函数与普通函数的区别"><a class="header-anchor" href="#箭头函数与普通函数的区别">#</a> 箭头函数与普通函数的区别</h3>
<ol>
<li>箭头函数里面的this对象，是定义时所在的对象，不是执行时所在的对象；</li>
<li>不可使用arguments对象；</li>
<li>不可使用yield命令；</li>
<li>不可使用new命令，因为：</li>
</ol>
<ul>
<li>没有自己的this，无法调用call、apply</li>
<li>没有prototype属性，而 new 命令在执行时需要将构造函数的 prototype 赋值给新的对象的 <strong>proto</strong></li>
</ul>
<h3 id="max-width-300px-可以覆盖掉-width-480px-important"><a class="header-anchor" href="#max-width-300px-可以覆盖掉-width-480px-important">#</a> max-width: 300px 可以覆盖掉 width: 480px !important</h3>
<h3 id="实现promise-finally"><a class="header-anchor" href="#实现promise-finally">#</a> 实现Promise.finally()</h3>
...
<div class="language-typescript ext-ts line-numbers-mode"><pre v-pre class="language-typescript"><code><span class="token builtin">Promise</span><span class="token punctuation">.</span>prototype<span class="token punctuation">.</span><span class="token function-variable function">all</span> <span class="token operator">=</span> <span class="token keyword">function</span><span class="token punctuation">(</span>promises<span class="token operator">:</span> <span class="token punctuation">[</span><span class="token punctuation">]</span><span class="token builtin">any</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
  ...
  <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br></div></div><h3 id="_1px-实现"><a class="header-anchor" href="#_1px-实现">#</a> 1px 实现</h3>
<ol>
<li>
<p>M站用到的方式是获取到全局的<code>devicePixelRatio</code>，然后用<code>devicePixelRatio * 16</code>去设置<code>font-size</code>，最后通过mete标签，将页面的scale设置为<code>1/devicePixelRatio</code></p>
</li>
<li>
<p>用 伪类 + <code>transform</code>缩放</p>
</li>
</ol>
<p>以上两个是最常用的，还有不怎么常用的：</p>
<ol start="3">
<li>
<p>border-image</p>
</li>
...
<h3 id="css-解决img底部空白间隙"><a class="header-anchor" href="#css-解决img底部空白间隙">#</a> CSS 解决img底部空白间隙</h3>
<p><a href="https://www.jianshu.com/p/e7373c2bbef1" target="_blank" rel="noopener noreferrer">参考<OutboundLink/></a></p>
<p>css底部有空隙，主要是由于img属于行内元素，其水平对齐方式依赖于vertical-align: baseline，所以如果希望去除空隙，可以通过以下方式进行：</p>
<p>方案1：修改img垂直居中的方式，使其不以基线对其。</p>
<div class="language-markup ext-html line-numbers-mode"><pre v-pre class="language-markup"><code><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>div</span><span class="token punctuation">></span></span>
...
<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>div</span><span class="token punctuation">></span></span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br></div></div><div class="language-css ext-css line-numbers-mode"><pre v-pre class="language-css"><code><span class="token selector">img</span> <span class="token punctuation">{</span>
  <span class="token property">vertical-align</span><span class="token punctuation">:</span> bottom<span class="token punctuation">;</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br></div></div><p>方案2：使行高为0</p>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br></div></div><p>方案3：修改字体大小</p>
<div class="language-css ext-css line-numbers-mode"><pre v-pre class="language-css"><code><span class="token selector">div</span> <span class="token punctuation">{</span>
  <span class="token property">font-size</span><span class="token punctuation">:</span> 0px<span class="token punctuation">;</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br></div></div><p>方案4：让img变成行内块级元素，不受基线影响</p>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br></div></div><h3 id="hash路由与history路由"><a class="header-anchor" href="#hash路由与history路由">#</a> hash路由与history路由</h3>
<p><a href="https://juejin.im/post/5f0fcb74e51d453490665e50?utm_source=gold_browser_extension" target="_blank" rel="noopener noreferrer">参考<OutboundLink/></a></p>
<h4 id="hash-是什么"><a class="header-anchor" href="#hash-是什么">#</a> hash 是什么？</h4>
<p>hash 指的是 url 的#及#后面的部分， 例如 https://www.baidu.com#123这个 url 里面#123就是 hash。</p>
<h4 id="为什么要使用-hash-路由"><a class="header-anchor" href="#为什么要使用-hash-路由">#</a> 为什么要使用 hash 路由？</h4>
<p>这是由于 hash 的特性决定的，hash 有以下特性：</p>
<ul>
<li>hash 只是客户端的一种状态，向服务器发送请求时，hash 部分不会被发送；</li>
<li>hash 值的改变会在浏览器中增加一个历史记录，因此我们能够根据浏览器的回退、前进按钮控制 hash 值的切换；</li>
<li>我们可以使用 hashchange 事件来监听 hash 值的变化。</li>
</ul>
<h4 id="如何使用-hash-路由"><a class="header-anchor" href="#如何使用-hash-路由">#</a> 如何使用 hash 路由？</h4>
<ol>
<li>
<p>通过a标签，并设置href属性，这样我们点击这个链接时，url 会改变并触发hashchange事件，此时页面如果有 id 为 hash值的元素时，点击链接也会跳转到对应的元素上方。</p>
</li>
<li>
<p><code>window.location.hash = &quot;test&quot;</code></p>
</li>
</ol>
<h3 id="history-路由"><a class="header-anchor" href="#history-路由">#</a> history 路由</h3>
<h4 id="什么是-history-路由"><a class="header-anchor" href="#什么是-history-路由">#</a> 什么是 history 路由？</h4>
<p>history 路由是使用html5中 window.history 对象提供的对浏览器会话历史访问的功能实现的路由。</p>
<h4 id="为什么要使用-history-路由"><a class="header-anchor" href="#为什么要使用-history-路由">#</a> 为什么要使用 history 路由？</h4>
<ul>
<li>url 样式更美观</li>
<li>history 对象提供了 pushState 和 replaceState 这个两个 API，可以在不进行刷新的情况下，操作浏览器的历史纪录</li>
<li>可以使用 popstate 事件来监听 url 的变化，但是要注意，使用pushState 和 replaceState 这个两个 API 改变路由不会触发popstate事件，能够触发popstate事件的只有go、back、forward这三个方法</li>
<li>要注意的是，使用 history 路由的时候如果刷新页面，浏览器会向服务器发送请求，如果后端没有做对应的处理页面会出现 404 错误，所以使用 history 路由的时候需要后端配合</li>
</ul>
<h3 id="this指向问题"><a class="header-anchor" href="#this指向问题">#</a> this指向问题</h3>
<p>除去不常用的 with 和 eval 的情况，具体到实际应用中，this 的指向大致可以分为以下 4 种。</p>
<ul>
<li>作为对象的方法调用：this 指向该对象；</li>
<li>作为普通函数调用：全局对象（浏览器中则为 window 对象，严格模式下，是 undefined）；</li>
<li>构造函数调用：指向返回的对象。特殊情况：若显示返回一个 object 类型的对象，那么此次运算结果最终会返回这个对象；对于显示返回非对象类型的数据，则会依然保持期待的 this。</li>
<li>Function.prototype.call 或 Function.prototype.apply 调用：动态改变传入函数的 this，若第一个参数为 null，则函数内的 this 会指向默认的宿主对象（浏览器是 window），但如果是严格模式，则 this 仍为 null。对于目的不在于指定 this 指向，而是借用其他对象的方法，那么可以传入 null 来代替某个具体的对象：Math.max.apply(null, [1, 2, 3])</li>
</ul>
<h3 id="function-prototype-bind"><a class="header-anchor" href="#function-prototype-bind">#</a> Function.prototype.bind</h3>
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code><span class="token class-name">Function</span><span class="token punctuation">.</span>prototype<span class="token punctuation">.</span><span class="token function-variable function">bind</span> <span class="token operator">=</span> <span class="token keyword">function</span> <span class="token function">bind</span><span class="token punctuation">(</span><span class="token parameter">context<span class="token punctuation">,</span> <span class="token operator">...</span>args</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
  ...
  <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br></div></div><p>上面的太过于基本了，对于特殊情况没有处理，其中有两点需要注意，</p>
<ol>
<li>
<p>第一就是万一调用的不是一个函数怎么办？</p>
</li>
<li>
<p>第二就是bind返回的函数可以new调用，需要保证new调用时this指向函数本身。</p>
</li>
</ol>
<p>依次两点，我们做如下改进：</p>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br></div></div><h3 id="函数柯里化currying"><a class="header-anchor" href="#函数柯里化currying">#</a> 函数柯里化currying</h3>
...
<h3 id="querytoobject"><a class="header-anchor" href="#querytoobject">#</a> queryToObject</h3>
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code><span class="token keyword">function</span> <span class="token function">queryToObj</span><span class="token punctuation">(</span><span class="token parameter">query</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
...
<p>对于<code>([^?&amp;]+)</code>这个正则表达式，表示需要匹配除了<code>？</code>和<code>&amp;</code>符号的所有字符，然后通过<code>$n</code>符号进行获取。</p>
<h3 id="class与用函数模仿的类的不同"><a class="header-anchor" href="#class与用函数模仿的类的不同">#</a> class与用函数模仿的类的不同</h3>
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code>在《深入理解<span class="token constant">ES6</span>的》书中，详细介绍了<span class="token keyword">class</span>类与用构造函数模仿类的不同：
...
试图在类的方法内部重写类名，会抛出错误。
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br></div></div><h3 id="react-fiber"><a class="header-anchor" href="#react-fiber">#</a> React fiber</h3>
<h4 id="react-fiber是什么"><a class="header-anchor" href="#react-fiber是什么">#</a> React Fiber是什么？</h4>
<p>Fiber是一个对象，用来表表征reconciliation阶段能够拆分的最小工作单元，构成一个链表结构</p>
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code>fiber <span class="token punctuation">{</span>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br></div></div><h4 id="为什么要用react-fiber"><a class="header-anchor" href="#为什么要用react-fiber">#</a> 为什么要用React Fiber？</h4>
<p>react 15</p>
<p>调用setState后，开始一系列js执行操作（<code>reconciliation</code>），直到渲染完成，这一阶段是同步过程，如果js执行占据主线程时间较长，会使页面的响应度变差，使得react在动画等表现出卡顿的现象。由于<code>reconciliation</code>的过程类似于函数的递归调用，所以又称为<code>stack reconciler</code>.</p>
<p>react 16</p>
<p>为了解决卡顿不流畅的问题，react重新设计了<code>reconciliation</code>算法，名为<code>fiber reconciler</code>。</p>
<h4 id="react-fabir-实现原理"><a class="header-anchor" href="#react-fabir-实现原理">#</a> react fabir 实现原理</h4>
<p>为了不使js过多的占用主线程，采用分片的方式进行处理。</p>
<blockquote>
<p>把一个耗时长的任务分成很多小片，每一个小片的运行时间很短，虽然总时间依然很长，但是在每个小片执行完之后，都给其他任务一个执行的机会，这样唯一的线程就不会被独占，其他任务依然有运行的机会。
React Fiber把更新过程碎片化，每执行完一段更新过程，就把控制权交还给React负责任务协调的模块，看看有没有其他紧急任务要做，如果没有就继续去更新，如果有紧急任务，那就去做紧急任务。</p>
</blockquote>
<p>https://zhuanlan.zhihu.com/p/26027085
https://juejin.im/post/5ab7b3a2f265da2378403e57
https://segmentfault.com/a/1190000018250127</p>
<h2 id="_07-23"><a class="header-anchor" href="#_07-23">#</a> 07.23</h2>
<h3 id="object-is"><a class="header-anchor" href="#object-is">#</a> Object.is</h3>
<p>今天看到<code>react hooks</code>中，使用<code>useState</code>变更<code>state</code>值的时候，判断<code>state</code>值是否一致时，<code>react</code>用的方法是<code>Object.is</code>，遂查询该方法的用法，记录于此。</p>
<p>比较两个值是否相等，无非就是看与<code>==</code>或者<code>===</code>之间的不同。</p>
<p>对于比较引用类型的数据，其使用的是浅比较，只要引用相同就判断相同，不会关注具体内容。</p>
<p>与<code>==</code>相比，<code>Object.is</code>不会进行隐式类型转换。</p>
<p>与<code>===</code>相比，<code>Object.is</code>将<code>+0</code>与<code>-0</code>视为不等，将<code>NaN</code>之间的比较视为不等。</p>
<h3 id="mete-标签"><a class="header-anchor" href="#mete-标签">#</a> mete 标签</h3>
<div class="language-markup ext-html line-numbers-mode"><pre v-pre class="language-markup"><code><span class="token comment">&lt;!-- 指定字网页字符集 --></span>
...
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br></div></div><h3 id="浏览器与node事件循环的区别"><a class="header-anchor" href="#浏览器与node事件循环的区别">#</a> 浏览器与node事件循环的区别</h3>
<p>https://juejin.im/post/6844903761949753352#heading-12</p>
<h3 id="react合成事件原理"><a class="header-anchor" href="#react合成事件原理">#</a> React合成事件原理</h3>
...
<h3 id="javascript-设计模式"><a class="header-anchor" href="#javascript-设计模式">#</a> javascript 设计模式</h3>
<h3 id="页面优化"><a class="header-anchor" href="#页面优化">#</a> 页面优化</h3>
<h3 id="https-原理"><a class="header-anchor" href="#https-原理">#</a> https 原理</h3>
</template>